                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          print(
                            'URL ${"http://localhost:1337${state.books!.data[index].image.url}"}',
                          );
                          return Container(
                            width: 120,
                            ...
                            child: Column(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    "www.localhost:1337${state.books!.data[index].image.url}",
                                    errorBuilder:
