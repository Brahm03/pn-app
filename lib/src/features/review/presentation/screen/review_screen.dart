...
class ReviewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color.fromARGB(230, 35, 13, 7).withAlpha(100),
        actions: [
          ...
          Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8),
                  color: Color.fromARGB(230, 43, 15, 9).withAlpha(100),
                ),
                child: Padding(
                  padding: const EdgeInsets.all(20.0),
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 10),
                      Text(
                        'A solid read with great pacing. The ending felt a bit rushed but overall it was a great addition to the series. The world-building is top notch as always.',
                        style: GoogleFonts.inter(
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                          color: Colors.white,
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 10),
                      Text(
                        'The plot twists were somewhat predictable, but I njoyed the prose. Its a light read, perfect for a weekend afternoon.',
                        style: GoogleFonts.inter(
                          fontWeight: FontWeight.w500,
                          fontSize: 16,
                          color: Colors.white,
